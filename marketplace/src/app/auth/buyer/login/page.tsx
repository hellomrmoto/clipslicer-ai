    ...
    <div className="min-h-screen bg-[#080808] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-10">
          ...
          <p className="mt-2 text-xs font-bold text-gray-600 uppercase tracking-widest">Sign in to order food</p>
        </div>
        ...
        <div className="mt-6 text-center space-y-2">
          <p className="text-sm text-gray-600">
            New here?{' '}
            <Link href="/auth/buyer/register" className="text-white font-bold hover:text-red-400 transition-colors">Create account</Link>
          </p>
          <p className="text-sm text-gray-700">
            Selling food?{' '}
            <Link href="/auth/vendor/login" className="text-gray-500 hover:text-white transition-colors">Vendor sign in</Link>
          </p>
        </div>
      </div>
    </div>
